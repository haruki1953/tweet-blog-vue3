...
import { postControlDeleteImportAllImageApi } from '@/api'
...
<template>
  <div class="setting-excess-import-delete">
    <ConfirmContainer
      ...
      title="确认要删除全部图片导入记录吗？"
      confirmText="删除"
      confirmType="danger"
      size="small"
    >
      <div class="control-lable">删除全部图片导入记录</div>
